...
print('The Mean, Mediam and Mode of score in Maths are {}, {} and {} respective'.format(math_mean, math_median, math_mode))
print('The Mean, Mediam and Mode of score in Reading are {}, {} and {} respective'.format(reading_mean, reading_median, reading_mode))
print('The Mean, Mediam and Mode of score in Writing are {}, {} and {} respective'.format(writing_mean, writing_median, writing_mode))

math_std_deviation = statistics.stdev(math_list)
reading_std_deviation = statistics.stdev(math_list)
writing_std_deviation = statistics.stdev(math_list)
